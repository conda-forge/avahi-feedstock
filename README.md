...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/avahi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/avahi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add avahi python-avahi
# for installing globally
pixi global install avahi python-avahi
```
...
It is possible to list all of the versions of `avahi` available on your platform:
...
```
pixi search avahi --channel conda-forge
```
